              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                  ...
                  <div className="desc">
                    ...
                    <p>I have experience building websites with modern JavaScript frameworks such as React,Angular and I used HTML5,CSS3 </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 text-center animate-box">
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-5">
                  ...
                  <div className="desc">
                    ...
                    <p>My journy at the world of data science started from my master thesis and still continues </p>
                  </div>
                </div>
              </div>
              {/*
